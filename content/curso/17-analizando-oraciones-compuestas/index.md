...
Pero, si no puedes...
<details>
  <summary>Encuentra aquí la respuesta.</summary>
  <ol>
    <li>Una norma <strong>había</strong> <strong>establecida</strong>.</li>
    <li>(Ellos) jamás <strong>debían</strong> <strong>devolverse</strong> los golpes durante las comidas.</li>
    <li>(Ellos) <strong>debían</strong> remitir el motivo de la disputa a Wendy, levantando cortésmente el brazo derecho y diciendo:</li>
    <li>(Yo) <strong>quiero</strong> <strong>quejarme</strong> de Fulanito.</li>
    <li>Lo que normalmente <strong>ocurría</strong> era que:</li>
    <li>(Ellos) se <strong>olvidaban</strong> de hacerlo.</li>
    <li>(Ellos) lo <strong>hacían</strong> demasiado.</li>
  </ol>
<br>
Dividirla y reorganizarla es una gran técnica para entender correctamente una oración compuesta.   
</details>
{{< /truco >}}
